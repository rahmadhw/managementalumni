...
<head>
    ...
    <link href="<?php echo base_url() ?>assets/plugins/bootstrap/css/swiper.css" rel="stylesheet">
	<link href="css/magnific-popup.css" rel="stylesheet">
	<link href="<?php echo base_url(); ?>assets/plugins/bootstrap/css/styles.css" rel="stylesheet">
...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        <h3>SISTEM INFORMASI PENGELOLAAN DATA ALUMNI SIPEDAL MUTU SMK MUHAMMADIYAH 1 PEKANBARU</h3>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">MOTO PENDIDIKAN</h5>
                                <div class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,</div>
                            </div>
                        </div>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright © <a href="#your-link">SI MUTU</a></p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
        ...
        <div class="container">
            <div class="row"> 
                <div class="col-lg-12">
                    <p class="p-small">Distributed by Mutu</p> 
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
    ...
    <!-- Scripts -->
    <script src="<?php echo base_url() ?>assets/plugins/jquery/jquery.min.js"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="<?php echo base_url() ?>assets/plugins/bootstrap/js/bootstrap.min.js"></script> <!-- Bootstrap framework -->
    <script src="<?php echo base_url() ?>assets/plugins/bootstrap/js/jquery.easing.min.js"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="<?php echo base_url() ?>assets/plugins/bootstrap/js/swiper.min.js"></script> <!-- Swiper for image and text sliders -->
    <script src="<?php echo base_url() ?>assets/plugins/bootstrap/js/jquery.magnific-popup.js"></script> <!-- Magnific Popup for lightboxes -->
    <script src="<?php echo base_url() ?>assets/plugins/bootstrap/js/scripts.js"></script> <!-- Custom scripts -->
</body>
</html>